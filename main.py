...
class ConverterApp(QMainWindow):
    ...
    def select_input_file(self):
        ...
        file_path, _ = file_dialog.getOpenFileName(self, "Wybierz plik wejściowy", "", "All Files (*)")
        if file_path:
            self.input_field.setText(file_path)

    def select_output_file(self):
        file_dialog = QFileDialog()
        file_path, _ = file_dialog.getSaveFileName(self, "Wybierz plik wyjściowy", "", "All Files (*)")
        if file_path:
